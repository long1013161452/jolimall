...
+ (NSString *)randomString:(int)length
{
    ...
    for (int i = 0; i < length; i++) {
        int count = arc4random() % str.length;
        string = [string stringByAppendingString:[str substringWithRange:NSMakeRange(count, 1)]];
    }
    return string;
}
...
- (NSString *)encryptString:(NSString *)string keyString:(NSString *)keyString iv:(NSString *)ivTwo {
    ...
    NSData *iv =[ivTwo dataUsingEncoding:NSUTF8StringEncoding];
