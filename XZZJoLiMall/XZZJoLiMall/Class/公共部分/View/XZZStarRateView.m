 ...
 *  实心
 */
#define ForegroundStarImage @"order_comments_solid"
/**
 *  x空心
 */
#define BackgroundStarImage @"order_comments_empty"

typedef void(^completeBlock)(CGFloat currentScore);

@interface XZZStarRateView ()
...
@implementation XZZStarRateView
...
- (UIView *)createStarViewWithImage:(NSString *)imageName {
    ...
    {
        FLAnimatedImageView *imageView = [[FLAnimatedImageView alloc] initWithImage:[UIImage imageNamed:imageName]];
...
- (void)layoutSubviews {
    ...
    __weak XZZStarRateView *weakSelf = self;
